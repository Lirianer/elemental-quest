...
{
	private const int WIDTH = 32 * 2;
	private const int HEIGHT = 32 * 2;
	...
	public CCoin(int aType)
	{
		setType (aType);
		setFrames (Resources.LoadAll<Sprite> ("Sprites/coin"));
		setName ("coin");
